...
import Brand from '../atoms/LogoBrand'
...
export default function PrimarySearchAppBar(props,children) {
    ...
    const renderMenu = (
        ...
        >
            ...
            {/* <Link to="/profile" className={classes.linksclass}><MenuItem onClick={handleMenuClose}>Profile</MenuItem></Link>
            <Link to="/myaccount" className={classes.linksclass}><MenuItem onClick={handleMenuClose}>My account</MenuItem></Link> */}
        </Menu>
    );
