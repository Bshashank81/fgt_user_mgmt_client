...
import { ProfileEmail, ProfilePassword, ProfileDeleteAccount } from "./BasicProfileBottom"
    ...
    return (
        <div>
            ...
            <div className={classes.width}>
                <Button variant="contained" classes={{ root: classes.colorbutton }} onClick={(event) => props.postToUserApi()}>Save</Button>
                <Snackbar
